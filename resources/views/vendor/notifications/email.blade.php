...
<tr><td align='center'>&nbsp;</td><td align='center'><a href="<?php echo  $actionUrl ;?>" style='color:#fff;padding:14px 22px;text-decoration:none;background-color:#0070EA;text-transform:uppercase;font-size:15px;font-weight:600;'>Reset Password</a></td><td align='center'>&nbsp;</td></tr>
