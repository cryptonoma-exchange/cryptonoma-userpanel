...
<article class="gridparentbox">
	...
	<div class="container sitecontainer">
            ...
            <li class="nav-item"><a class="nav-link " href="{{ url('/withdrawhistory/BTC') }}">@lang('common.withdrawhistory.withdrawhistory')</a>
            </li>
              <li class="nav-item"><a class="nav-link active"  href="{{ url('/orderhistory/BTC') }}">Order History</a></li>	 
            </ul>
					</div>
