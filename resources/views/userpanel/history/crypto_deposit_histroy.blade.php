				...
				<div class="panelcontentbox">
					<div class="innerpagetab historytab">				
						<ul class="nav nav-tabs tabbanner" role="tablist">
							<li class="nav-item"><a class="nav-link"  href="{{url('tradehistroy/BTC_USDC/Buy/limit')}}">@lang('common.deposithistory.tradehistory')</a></li>
							<li class="nav-item"><a class="nav-link active"   href="{{ url('/deposithistory/BTC') }}">@lang('common.deposithistory.deposithistory')</a></li>					
              <li class="nav-item"><a class="nav-link"   href="{{ url('/withdrawhistory/BTC') }}">@lang('common.deposithistory.withdrawhistory')</a></li>	
