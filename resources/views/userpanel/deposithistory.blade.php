...
@include('layouts.userpanel.headermenu')
		...
		<li><a href="{{ route('wallet') }}"><img src="{{url('userpanel/images/wallet1.svg') }}"/><div>Spot Wallet</div></a></li>
				...
				<li><a href="{{ route('deposithistory') }}" class="active"><img src="{{url('userpanel/images/deposit.svg') }}"/><div>Deposit History</div></a></li>
	...
	<article class="gridparentbox">		
		...
		<div class="panelcontentbox">	
            <h2 class="heading-box">Deposit History</h2>
