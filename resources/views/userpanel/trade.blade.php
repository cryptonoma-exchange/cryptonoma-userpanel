...
if(Auth::user()->tradefee_status == 1)
$tradefee_status = 1;
@endphp
                                                    ...
                                                    <tbody id="livemarket">
                                                        @foreach ($value as $keys)
                                                            <tr class=" {{ $coinone == $keys && $cointwo == $key ? 'activerow' : '' }}"
                                                                onclick="window.location='{{ url('/trades/' . $keys . '_' . $key) }}'"
                            ...
                            <div class="tab-content">
                                            ...
                                            <div class="buyorderform">
                                                ...
                                                @if (isset($balance[$cointwo]['balance']))
                                                        ...
                                                        <div class="alert alert-danger alert-block">
                                                            <button type="button" class="close" data-dismiss="alert">×</button>
                                                            <strong>{{ "wallet balance is 0 KES" }}</strong>
                                                            <a href="{{ url('deposit/KES') }}" >DEPOSIT</a>
                                                        </div>
                                                        @endif
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" placeholder="" class="form-control"
                                                                ...
                                                                name="buytotalmarketkes" placeholder="Total" disabled>
                                                            <div class="input-group-append">
                                                                {{-- <span
                                                                    class="input-group-text">{{ $cointwo }}</span> --}}
                                                                    <span
                                ...
                                <div id="sell" class="tab-pane">
                                    ...
                                    <div class="tab-content">
                                                ...
                                                <form class="siteformbg" id="sellimit">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <div><span class="feeamt"><span
                                                                        id="sellfees">{{ display_format(0, $coinone_decimal) }}</span>
                                                                    {{ $coinone }}</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div>
                                                        @if (Auth::user()->kyc_verify == 1)
                                                            <input type="button" id="selllimit_order" name=""
                                                                class="btn btn-block sitebtn red-btn" value="Sell" />
                                                        @else
                                                            <input type="button" id="" name=""
                                                                onclick="location.href='{{ url('/kyc') }}';"
                                        ...
                                        <div id="market1" class="tab-pane active">
                                            <div class="sellorderform">
                                                <div class="balancewlt">
                                                    <h6 class="h6"><img
                                                            src="{{ url('images/wallet.svg') }}"><span
                                                ...
                                                <form class="siteformbg" id="sellmarket">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            {{-- <div><span class="feeamt"><span
                                                                    ...
                                                                    {{ $coinone }}</span></div> --}}
                                                                    <div><span class="feeamt"><span
                                                                        id="sellmarketfees">{{ display_format(0, $coinone_decimal) }}</span>
                                                                    {{ $coinone }}</span></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" placeholder="" class="form-control"
                                                                ...
                                                                name="selltotalmarketkes" placeholder="Total" disabled>
                                                            <div class="input-group-append">
                                                                {{-- <span
                                                                    class="input-group-text">{{ $cointwo }}</span> --}}
                                                                    <span
                                                    ...
                                                    <div>
                                                        @if (Auth::user()->kyc_verify == 1)
                                                            <input type="button" id="sellmarket_submit" name=""
                                                                class="btn btn-block sitebtn red-btn" value="Sell" />
                                                        @else
                                                            <input type="button" id="" name=""
                                                                onclick="location.href='{{ url('/kyc') }}';"
    ...
    function sellcal() {
        ...
        if (sellmarketprice > 0 && sellmarketvolume > 0) {
            if (sellmarkettotal > 0) {
                ...
                $('#sellmarketfees').html(toFixed(feemarket,{{ $coinone_decimal }}));
            } else {
...
<script>
    ...
    /********** websocket **************/
    @php //$uid = \Crypt::encrypt(Auth::user()->id);
    $uid = Auth::user()->id;
    @endphp
    @php $uid1 = Auth::user()->id; @endphp
    $(document).ready(function() {
        var websocket = new WebSocket(@json(config("app.websocket.url")));
            ...
            if (Data.coinone == "{{ $coinone }}" && Data.cointwo == "{{ $cointwo }}") {
                if(trade_pair_type == 0){
                    ...
                    if (Data.hoursexchange) {
                        var color = 't-red';
                        if (Data.hoursexchange > 0) {
                            color = 't-green';
                        }
                        $('#hoursexchange').html('24H change<span class="' + color + '" >' + Data
                            .hoursexchange + ' %</span>');
                        //  $('#hoursexchange').html(Data.hoursexchange);
                        @if ($trdepair->type == 0)
                        $('#orderpercent').html('<span class="' + color + '" >' + Data.hoursexchange +
                            ' %</span>');
                        @endif
                    }
                }
                ...
                if (Data.token) {
                    if (Data.token == '{{ $uid }}') {
                        ...
                        if (Data.myallorders) {
                            $('#myallorders').html(order_history(Data.myallorders));
                        }
                        if (Data.myopenorders) {
                            $('#myopenorders').html(open_orders(Data.myopenorders));
                        }
                    }
                }
        ...
        $("#buylimit_order").click(function() {
            $("#buylimit_order").addClass("hide");
            $('.loader').show();
            $('#buylimitmsg').html("");
            $.ajax({
                type: "POST",
                url: '{{ route('buylimit') }}', // This is what I have updated
                data: $("#buylimit").serialize(),
            }).done(function(request) {
                if (request.status == 'buylimitsuccess') {
                    $('#buylimit')[0].reset();
                    $('#buylimitmsg').html(request.msg);
                    $('.buybalance').html(request.balance);
                    $('.loader').hide();
                    $("#buyprice").val();
                    $("#buyvolume").val('');
                    $("#buytotal").val('');
                ...
                $("#buylimit_order").removeClass("hide");
            });
        });
        $("#selllimit_order").click(function() {
            $("#selllimit_order").addClass("hide");
            $('.loader').show();
            $('#selllimitmsg').html("");
            $.ajax({
                type: "POST",
                ...
                if (request.status == 'selllimitsuccess') {
                    ...
                    $('.sellbalance').html(request.balance);
                    $('.loader').hide();
                    $("#selltotal").val('');
                    $("#sellfees").val('');
                    var spans = $('#sellfees');
                ...
                $("#selllimit_order").removeClass("hide");
            });
        });
        $("#buymarket_submit").click(function() {
            $("#buymarket_submit").addClass("hide");
            $('.loader').show();
            $.ajax({
                type: "POST",
                ...
                $("#buymarket_submit").removeClass("hide");
            });
        });
        $("#sellmarket_submit").click(function() {
            $("#sellmarket_submit").addClass("hide");
            $('.loader').show();
            $.ajax({
                type: "POST",
                ...
                $("#sellmarket_submit").removeClass("hide");
            });
        });
    ...
    function removeErrorMessages(){
        $(".buylimitmsg").html("");
        $(".buylimitwarning").remove();

        $(".selllimitmsg").html("");
        $(".selllimitwarning").remove();

        $(".buymarketmsg").html("");
        $(".buymarketwarning").remove();

        $(".sellmarketmsg").html("");
        $(".sellmarketwarning").remove();
    }
    ...
    function Fillbuyvolume(id) {
        ...
        $.ajax({
            ...
            if (request.success == true) {
                var usdtotal = parseFloat(request.totalvalue /valusd).toFixed(@json($cointwo_decimal));
                var usdvolume = parseFloat(usdtotal / price).toFixed(@json($coinone_decimal));
                $("#buyvolume").val(usdvolume);
                $("#buytotal").val(usdtotal);
    ...
    function Fillsellvolume(id) {
        ...
        $.ajax({
            ...
            $('.loader').hide();
            if (request.success == true) {                                
                var usdvolume = parseFloat(request.totalvalue * price).toFixed(@json($coinone_decimal));
                var kestotal = parseFloat(usdvolume *valusd).toFixed(@json($cointwo_decimal));
                $("#sellvolume").val(request.totalvalue);
                $("#selltotal").val(usdvolume);
                $("#selltotalkes").val(kestotal); //updated
                $('#sellfees').html(parseFloat(request.sellingfee).toFixed(@json($coinone_decimal)));
            } else {
    ...
    function Fillmarketsellvolume(id) {
        ...
        $.ajax({
            ...
            if (request.success == true) {
                ...
                $('#sellmarketfees').html(toFixed(request.sellingfee,{{ $coinone_decimal }}));
            } else {
...
$(document).ready(function(){
    ...
    var conv = 1; //'{{$trdepair->conv_price}}';

    setInterval(function(){
        $(".currentMarketPrice").val(window.last_price);
        $("#buymarketvolume,#sellmarketvolume").trigger("change");
    }, 15*1000);

    window.conn_first = true;
             ...
             if((typeof get_data['e'] == "24hrTicker") || (get_data['e'] != null)) {
                ...
                if((typeof price_change != 'undefined') && (typeof last_price != 'undefined')) {
                    ...
                    if(@json($coinone_binance.$cointwo_binance) == symbol){
                        if(window.conn_first){
                            $(".currentMarketPrice").val(livePrice);
                            $("#buymarketvolume,#sellmarketvolume").trigger("change");
                        }
                        window.conn_first = false;
                        window.last_price = livePrice;
                    }
...
<script type='text/javascript'>
   ...
   $("#cancelbuytrade").click(function(){
            
           $('.loader').show();
           $("#myModalbuy").modal('hide');
   
           var cancel_id=$("#hidden_buycancel_id").val();
           var pair=$("#hidden_buypair_id").val();
           
           var string = cancel_id;
           string += "/";
           string += pair;
           $.ajax({
               type: "POST",
               url: '{{ url("tradecancelbuyorder") }}/'+ string, 
               data: {
                   "_token": "{{ csrf_token() }}",
               }
           }).done(function(request) {
               ...
               if (request.success == true) {
                ...
                $('.loader').hide();
                $('#cancelsuccess').show();
                   $('#cancelsuccess').html(request.result.message);
                   $("#coinTwobalance_market").html(parseFloat(request.result.balance).toFixed(8));
            $('#buybalance').html(parseFloat(request.result.balance).toFixed(8));
                   var messageJSON = {
                   market: "{{ $coinone }}_{{ $cointwo }}",
                   _token: "{{ $uid }}"
                     };
               websocket.send(JSON.stringify(messageJSON));       
                ...
                $("#buylimitmsg").show();
                    $('#cancelerror').show();
                   $('#cancelerror').html(request.result.message);
               } 
     ...
     function cancel_selltrade(cancel_id,pair)
   {
       ...
       $("#cancelselltrade").click(function(){
           
           $('.loader').show();
           $("#myModalsell").modal('hide');
   
           var cancel_id=$("#hidden_sellcancel_id").val();
           var pair=$("#hidden_sellpair_id").val();
           ...
           $.ajax({
               type: "POST",
               url: '{{ url("tradecancelsellorder") }}/'+ string, 
               data: {
                   "_token": "{{ csrf_token() }}",
               }
           }).done(function(request) {
               ...
               if (request.success == true) {
                ...
                $('.loader').hide();
                    $('#cancelsuccess').show();
                   $('#cancelsuccess').html(request.result.message);
                   $("#coinOnebalance_market").html(parseFloat(request.result.balance).toFixed(8));
            $('#sellbalance').html(parseFloat(request.result.balance).toFixed(8));
