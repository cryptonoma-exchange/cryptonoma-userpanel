...
<tr><td align='center'>&nbsp;</td><td align='center'><a href="{{ url('verify/'.\Crypt::encryptString($user->email)) }}"     style='color:#fff;padding:14px 22px;text-decoration:none;background-color:#0070EA;text-transform:uppercase;font-size:15px;font-weight:600;'>Verify to proceed</a></td><td align='center'>&nbsp;</td></tr>
<tr><td colspan='3' align='center' height='30' style='padding:0px;'></td></tr>
<!-- 
